...
Дополнительно поддерживает постобработку сохраненных документов: токенизацию, группировку токенов по леммам, построение инвертированного индекса и булев поиск.
