...
Дополнительно поддерживает постобработку сохраненных документов: токенизацию, группировку токенов по леммам, построение инвертированного индекса по леммам и булев поиск (AND, OR, NOT, скобки).
